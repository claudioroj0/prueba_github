...
import { IonHeader, IonToolbar, IonTitle, IonButton, IonIcon, IonContent, IonFooter } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [
    IonHeader, IonToolbar, IonTitle, IonButton, IonIcon, IonContent, IonFooter, CommonModule, TranslateModule
  ]
})
