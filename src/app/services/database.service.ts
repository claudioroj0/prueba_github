...
export class DatabaseService {
  ...
  testUser3 = User.getNewUsuario(
    ...
    adminUser = User.getNewUsuario(
      ...
      'Admin', 
      'istrador', 
      EducationalLevel.findLevel(6)!, // El nivel más alto es 6
      new Date(1987, 11, 13),
      'Recoleta ',
      'default-image.jpg');
  ...
  async createTestUsers() {
    try {
      ...
      // Verifica y guarda al usuario administrador si no existe
      const admin = await this.readUser(this.adminUser.userName);
      if (!admin) {
