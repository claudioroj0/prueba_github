describe('template spec', () => {
  ...
  //    cy.visit('http://10.20.6.93:8102/').then(()=>{
  //      cy.get('#cuenta').invoke('val','correo-inexistente@duocuc.cl');
  ...
  // it('Eliminar esa publicacion', () => {
  //   cy.visit('http://192.168.1.138:8102/').then(() => {
  //     cy.get('#cuenta').invoke('val', '');
  //     cy.get('#cuenta').type('atorres');
  //     cy.get('#password').invoke('val', '');
  //     cy.get('#password').type('1234');
